...
from keras.layers import Conv2D, concatenate, BatchNormalization, Lambda, Input, multiply, add, ZeroPadding2D, \
    Activation, Layer, MaxPooling2D, Dropout
...
class EAST_model:
    ...
    def __init__(self, input_size=512):
        ...
        text_region_boundary_mask = Input(shape=(None, None, 1), name='text_region_boundary_mask')
        ...
        model = Model(inputs=[input_image, text_region_boundary_mask, target_score_map],
                      outputs=[pred_score_map, pred_geo_map])
        self.model = model
        self.input_image = input_image
        self.text_region_boundary_mask = text_region_boundary_mask
